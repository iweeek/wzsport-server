...
public class StudentCoursePhysicalTestType {
	...
	public static GraphQLFieldDefinition getSingleQueryField() {
		if (singleQueryField == null) {
			singleQueryField = GraphQLFieldDefinition.newFieldDefinition()
					...
					.name("StudentCoursesPhysicalTestSingle")
					.description("根据条件来获取学生")
					.type(getType())
					.dataFetcher(environment -> {
						String openId = environment.getArgument("openId");
						...
						if (list != null) {
							...
							studentExample.createCriteria().andUserIdEqualTo(user.getId());
	...
	public void setUserMapper(UserMapper userMapper) {
		StudentCoursePhysicalTestType.userMapper = userMapper;
	}
	@Autowired(required = true)
	public void setStudentMapper(StudentMapper studentMapper) {
		StudentCoursePhysicalTestType.studentMapper = studentMapper;
	}
}
