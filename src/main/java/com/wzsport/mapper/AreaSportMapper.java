...
public interface AreaSportMapper {
	 ...
	 * @mbg.generated  Wed Jul 26 22:10:51 CST 2017
	 */
	@Insert({ "insert into wzsport_area_sport (university_id, name, ", "is_enable, addr, type, ",
			"qualified_cost_time, acquisition_interval, ", "sample_num)",
			"values (#{universityId,jdbcType=BIGINT}, #{name,jdbcType=VARCHAR}, ",
			"#{isEnable,jdbcType=BIT}, #{addr,jdbcType=VARCHAR}, #{type,jdbcType=TINYINT}, ",
			"#{qualifiedCostTime,jdbcType=INTEGER}, #{acquisitionInterval,jdbcType=TINYINT}, ",
			"#{sampleNum,jdbcType=TINYINT})" })
	 ...
	 * @mbg.generated  Wed Jul 26 22:10:51 CST 2017
	 */
	@Select({ "select", "id, university_id, name, is_enable, addr, type, qualified_cost_time, acquisition_interval, ",
			"sample_num", "from wzsport_area_sport", "where id = #{id,jdbcType=BIGINT}" })
	...
	@Update({ "update wzsport_area_sport", "set university_id = #{universityId,jdbcType=BIGINT},",
			...
			"addr = #{addr,jdbcType=VARCHAR},", "type = #{type,jdbcType=TINYINT},",
			"qualified_cost_time = #{qualifiedCostTime,jdbcType=INTEGER},",
			"acquisition_interval = #{acquisitionInterval,jdbcType=TINYINT},",
			"sample_num = #{sampleNum,jdbcType=TINYINT}", "where id = #{id,jdbcType=BIGINT}" })
