...
public interface RunningActivityMapper {
    ...
    @Insert({ "insert into wzsport_running_activity (running_sport_id, end_running_sport_id, ",
            ...
            "qualified_distance, qualified_cost_time, ", "min_cost_time, comment, ", "comment_user, created_at, ",
            ...
            "#{minCostTime,jdbcType=INTEGER}, #{comment,jdbcType=VARCHAR}, ",
            "#{commentUser,jdbcType=BIGINT}, #{createdAt,jdbcType=TIMESTAMP}, ",
    ...
    @Select({ "select", "id, running_sport_id, end_running_sport_id, student_id, distance, step_count, ",
            ...
            "min_cost_time, comment, comment_user, created_at, updated_at, ended_at, ended_by",
    ...
    @Update({ "update wzsport_running_activity", "set running_sport_id = #{runningSportId,jdbcType=BIGINT},",
            ...
            "min_cost_time = #{minCostTime,jdbcType=INTEGER},", "comment = #{comment,jdbcType=VARCHAR},",
            "comment_user = #{commentUser,jdbcType=BIGINT},", "created_at = #{createdAt,jdbcType=TIMESTAMP},",
