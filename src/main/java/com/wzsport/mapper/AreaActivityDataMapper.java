...
public interface AreaActivityDataMapper {
	 ...
	 * @mbg.generated  Fri Aug 18 10:38:11 CST 2017
	 */
	@Insert({ "insert into wzsport_area_activity_data (activity_id, acquisition_time, ", "longitude, latitude, ",
			...
			"#{locationType,jdbcType=TINYINT}, #{createdAt,jdbcType=TIMESTAMP}, ", "#{updatedAt,jdbcType=TIMESTAMP})" })
	 ...
	 * @mbg.generated  Fri Aug 18 10:38:11 CST 2017
	 */
	@Select({ "select", "id, activity_id, acquisition_time, longitude, latitude, location_type, created_at, ",
			"updated_at", "from wzsport_area_activity_data", "where id = #{id,jdbcType=BIGINT}" })
	...
	@Update({ "update wzsport_area_activity_data", "set activity_id = #{activityId,jdbcType=BIGINT},",
			"acquisition_time = #{acquisitionTime,jdbcType=TIMESTAMP},", "longitude = #{longitude,jdbcType=DECIMAL},",
