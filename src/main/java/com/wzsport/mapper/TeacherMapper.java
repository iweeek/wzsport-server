...
public interface TeacherMapper {
	 ...
	 * @mbg.generated  Mon Apr 16 11:29:36 CST 2018
	 */
	@Insert({ "insert into wzsport_teacher (job_no, university_id, ", "name, is_man)",
			"values (#{jobNo,jdbcType=VARCHAR}, #{universityId,jdbcType=BIGINT}, ",
			"#{name,jdbcType=VARCHAR}, #{man,jdbcType=BIT})" })
	 ...
	 * @mbg.generated  Mon Apr 16 11:29:36 CST 2018
	 */
	@Select({ "select", "id, job_no, university_id, name, is_man", "from wzsport_teacher",
	...
	@Update({ "update wzsport_teacher", "set job_no = #{jobNo,jdbcType=VARCHAR},",
			...
			"is_man = #{man,jdbcType=BIT}", "where id = #{id,jdbcType=BIGINT}" })
