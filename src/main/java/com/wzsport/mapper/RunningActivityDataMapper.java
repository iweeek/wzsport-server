...
public interface RunningActivityDataMapper {
	...
	@Insert({ "insert into wzsport_running_activity_data (activity_id, acquisition_time, ", "step_count, distance, ",
			"stride, steps_per_second, ", "longitude, latitude, ", "location_type, is_normal, ",
			"created_at, updated_at)", "values (#{activityId,jdbcType=BIGINT}, #{acquisitionTime,jdbcType=TIMESTAMP}, ",
			"#{stepCount,jdbcType=SMALLINT}, #{distance,jdbcType=SMALLINT}, ",
			"#{stride,jdbcType=DECIMAL}, #{stepsPerSecond,jdbcType=DECIMAL}, ",
	 ...
	 * @mbg.generated  Fri Aug 25 21:41:22 CST 2017
	 */
	@Select({ "select", "id, activity_id, acquisition_time, step_count, distance, stride, steps_per_second, ",
	...
	@Update({ "update wzsport_running_activity_data", "set activity_id = #{activityId,jdbcType=BIGINT},",
			...
			"distance = #{distance,jdbcType=SMALLINT},", "stride = #{stride,jdbcType=DECIMAL},",
			"steps_per_second = #{stepsPerSecond,jdbcType=DECIMAL},", "longitude = #{longitude,jdbcType=DECIMAL},",
