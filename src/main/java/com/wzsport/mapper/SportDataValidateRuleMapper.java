...
public interface SportDataValidateRuleMapper {
	 ...
	 * @mbg.generated  Sun Aug 27 14:55:14 CST 2017
	 */
	@Insert({ "insert into wzsport_sport_data_validate_rule (distance_per_step, step_per_second, ",
			"speed, validate_mode)", "values (#{distancePerStep,jdbcType=DECIMAL}, #{stepPerSecond,jdbcType=DECIMAL}, ",
			"#{speed,jdbcType=DECIMAL}, #{validateMode,jdbcType=TINYINT})" })
	 ...
	 * @mbg.generated  Sun Aug 27 14:55:14 CST 2017
	 */
	@Select({ "select", "id, distance_per_step, step_per_second, speed, validate_mode",
	...
	@Update({ "update wzsport_sport_data_validate_rule", "set distance_per_step = #{distancePerStep,jdbcType=DECIMAL},",
			"step_per_second = #{stepPerSecond,jdbcType=DECIMAL},", "speed = #{speed,jdbcType=DECIMAL},",
