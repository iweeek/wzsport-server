...
public interface FixLocationOutdoorSportPointMapper {
	...
	@Insert({ "insert into wzsport_fix_location_outdoor_sport_point (name, latitude, ", "longitude, radius, ",
			"university_id, description)", "values (#{name,jdbcType=VARCHAR}, #{latitude,jdbcType=DECIMAL}, ",
			"#{longitude,jdbcType=DECIMAL}, #{radius,jdbcType=TINYINT}, ",
			"#{universityId,jdbcType=INTEGER}, #{description,jdbcType=VARCHAR})" })
	 ...
	 * @mbg.generated  Sat Jul 22 14:24:37 CST 2017
	 */
	@Select({ "select", "id, name, latitude, longitude, radius, university_id, description",
