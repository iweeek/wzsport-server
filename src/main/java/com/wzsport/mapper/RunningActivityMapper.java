...
public interface RunningActivityMapper {
	...
	@Insert({ "insert into wzsport_running_activity (project_id, student_id, ", "distance, cost_time, ",
			"target_time, start_time, ", "calories_consumed, qualified, ", "created_at, updated_at)",
	 ...
	 * @mbg.generated  Fri Jun 16 10:13:10 CST 2017
	 */
	@Select({ "select", "id, project_id, student_id, distance, cost_time, target_time, start_time, calories_consumed, ",
