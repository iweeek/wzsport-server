...
public interface FixLocationOutdoorSportPointMapper {
	...
	@Insert({ "insert into wzsport_fix_location_outdoor_sport_point (name, latitude, ", "longitude, radius, ",
			"university_id, description, ", "is_enable)",
	 ...
	 * @mbg.generated  Sat Jul 22 22:13:08 CST 2017
	 */
	@Select({ "select", "id, name, latitude, longitude, radius, university_id, description, is_enable",
	...
	@Update({ "update wzsport_fix_location_outdoor_sport_point", "set name = #{name,jdbcType=VARCHAR},",
			...
			"radius = #{radius,jdbcType=TINYINT},", "university_id = #{universityId,jdbcType=INTEGER},",
