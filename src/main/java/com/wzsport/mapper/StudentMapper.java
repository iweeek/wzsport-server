...
public interface StudentMapper {
	 ...
	 * @mbg.generated  Mon May 28 16:50:53 CST 2018
	 */
	@Insert({ "insert into wzsport_student (user_id, class_id, ", "university_id, student_no, ", "is_man, name)",
			"values (#{userId,jdbcType=BIGINT}, #{classId,jdbcType=BIGINT}, ",
			"#{universityId,jdbcType=BIGINT}, #{studentNo,jdbcType=VARCHAR}, ",
			"#{man,jdbcType=BIT}, #{name,jdbcType=VARCHAR})" })
	 ...
	 * @mbg.generated  Mon May 28 16:50:53 CST 2018
	 */
	@Select({ "select", "id, user_id, class_id, university_id, student_no, is_man, name", "from wzsport_student",
	...
	@Update({ "update wzsport_student", "set user_id = #{userId,jdbcType=BIGINT},",
			...
			"name = #{name,jdbcType=VARCHAR}", "where id = #{id,jdbcType=BIGINT}" })
