...
public interface StudentSportConsumeStatisticMapper {
     ...
     * @mbg.generated  Mon Oct 30 11:57:50 CST 2017
     */
    @Insert({ "insert into wzsport_student_sport_consume_statistic (user_id, student_id, ", "student_no, class_id, ",
            "major_id, college_id, ", "university_id, kcal_consumed, ", "cost_time, is_man, name, ",
            "avatar_url, sport_date)", "values (#{userId,jdbcType=BIGINT}, #{studentId,jdbcType=BIGINT}, ",
            "#{studentNo,jdbcType=VARCHAR}, #{classId,jdbcType=BIGINT}, ",
            "#{majorId,jdbcType=BIGINT}, #{collegeId,jdbcType=BIGINT}, ",
            "#{universityId,jdbcType=BIGINT}, #{kcalConsumed,jdbcType=BIGINT}, ",
            "#{costTime,jdbcType=BIGINT}, #{isMan,jdbcType=BIT}, #{name,jdbcType=VARCHAR}, ",
     ...
     * @mbg.generated  Mon Oct 30 11:57:50 CST 2017
     */
    @Select({ "select", "id, user_id, student_id, student_no, class_id, major_id, college_id, university_id, ",
            "kcal_consumed, cost_time, is_man, name, avatar_url, sport_date",
            "from wzsport_student_sport_consume_statistic", "where id = #{id,jdbcType=BIGINT}" })
    ...
    @Update({ "update wzsport_student_sport_consume_statistic", "set user_id = #{userId,jdbcType=BIGINT},",
            "student_id = #{studentId,jdbcType=BIGINT},", "student_no = #{studentNo,jdbcType=VARCHAR},",
            "class_id = #{classId,jdbcType=BIGINT},", "major_id = #{majorId,jdbcType=BIGINT},",
            "college_id = #{collegeId,jdbcType=BIGINT},", "university_id = #{universityId,jdbcType=BIGINT},",
            "kcal_consumed = #{kcalConsumed,jdbcType=BIGINT},", "cost_time = #{costTime,jdbcType=BIGINT},",
	...
	List<StudentSportConsumeStatistic> getStudentSportConsumeStatisticList(@Param("start") Date start,@Param("end") Date end);
