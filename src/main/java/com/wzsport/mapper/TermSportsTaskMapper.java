...
public interface TermSportsTaskMapper {
	 ...
	 * @mbg.generated  Mon May 28 16:50:53 CST 2018
	 */
	@Insert({ "insert into wzsport_term_sports_task (term_id, target_sports_times)",
	 ...
	 * @mbg.generated  Mon May 28 16:50:53 CST 2018
	 */
	@Select({ "select", "id, term_id, target_sports_times", "from wzsport_term_sports_task",
	...
	@Update({ "update wzsport_term_sports_task", "set term_id = #{termId,jdbcType=BIGINT},",
			"target_sports_times = #{targetSportsTimes,jdbcType=TINYINT}", "where id = #{id,jdbcType=BIGINT}" })
