...
public interface StudentSportConsumeStatisticMapper {
	...
	/**
     * This method was generated by MyBatis Generator. This method corresponds to the database table wzsport_student_sport_consume_statistic_new
     ...
     * @mbg.generated  Wed Nov 22 00:16:19 CST 2017
     */
    @Delete({ "delete from wzsport_student_sport_consume_statistic_new", "where id = #{id,jdbcType=BIGINT}" })
     ...
     * @mbg.generated  Wed Nov 22 00:16:19 CST 2017
     */
    @Insert({ "insert into wzsport_student_sport_consume_statistic_new (user_id, student_id, ",
    ...
    @Select({ "select", "id, user_id, student_id, kcal_consumed, cost_time, class_id, university_id, ",
            ...
            "major_name, college_name", "from wzsport_student_sport_consume_statistic_new",
     ...
     * @mbg.generated  Wed Nov 22 00:16:19 CST 2017
     */
    @Update({ "update wzsport_student_sport_consume_statistic_new", "set user_id = #{userId,jdbcType=BIGINT},",
