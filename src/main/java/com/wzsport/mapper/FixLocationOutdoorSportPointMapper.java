...
public interface FixLocationOutdoorSportPointMapper {
	...
	@Insert({ "insert into wzsport_fix_location_outdoor_sport_point (name, latitude, ", "longitude, radius, ",
			"qualified_cost_time, addr, ", "university_id, description, ", "is_enable)",
			...
			"#{universityId,jdbcType=INTEGER}, #{description,jdbcType=VARCHAR}, ", "#{isEnable,jdbcType=TINYINT})" })
	 ...
	 * @mbg.generated  Fri Jul 28 14:54:12 CST 2017
	 */
	@Select({ "select", "id, name, latitude, longitude, radius, qualified_cost_time, addr, university_id, ",
			"description, is_enable", "from wzsport_fix_location_outdoor_sport_point",
	...
	@Update({ "update wzsport_fix_location_outdoor_sport_point", "set name = #{name,jdbcType=VARCHAR},",
			...
			"radius = #{radius,jdbcType=TINYINT},", "qualified_cost_time = #{qualifiedCostTime,jdbcType=INTEGER},",
			"addr = #{addr,jdbcType=VARCHAR},", "university_id = #{universityId,jdbcType=INTEGER},",
			"description = #{description,jdbcType=VARCHAR},", "is_enable = #{isEnable,jdbcType=TINYINT}",
			"where id = #{id,jdbcType=BIGINT}" })
