...
public interface UserMapper {
	...
	@Insert({ "insert into wzsport_user (username, password, ", "university_id, latest_token, ",
			"avatar_url, open_id, ", "created_at, updated_at)",
	 ...
	 * @mbg.generated  Sun Sep 03 10:28:31 CST 2017
	 */
	@Select({ "select", "id, username, password, university_id, latest_token, avatar_url, open_id, created_at, ",
			"updated_at", "from wzsport_user", "where id = #{id,jdbcType=BIGINT}" })
	...
	@Update({ "update wzsport_user", "set username = #{username,jdbcType=VARCHAR},",
			...
			"open_id = #{openId,jdbcType=VARCHAR},", "created_at = #{createdAt,jdbcType=TIMESTAMP},",
