...
public interface SportScoreMapper {
	 ...
	 * @mbg.generated  Tue Jun 06 22:11:58 CST 2017
	 */
	@Insert({ "insert into wzsport_sport_score (student_id, meter50_sprint_time, ",
			"meter50_sprint_score, standing_jump_distance, ", "standing_jump_score, meter1500_run_time, ",
			"meter1500_run_score, abdominal_curl_count, ", "abdominal_curl_score, created_at, ", "updated_at)",
			"values (#{studentId,jdbcType=BIGINT}, #{meter50SprintTime,jdbcType=DECIMAL}, ",
			"#{meter50SprintScore,jdbcType=TINYINT}, #{standingJumpDistance,jdbcType=SMALLINT}, ",
			"#{standingJumpScore,jdbcType=TINYINT}, #{meter1500RunTime,jdbcType=SMALLINT}, ",
			"#{meter1500RunScore,jdbcType=TINYINT}, #{abdominalCurlCount,jdbcType=TINYINT}, ",
			"#{abdominalCurlScore,jdbcType=TINYINT}, #{createdAt,jdbcType=TIMESTAMP}, ",
	 ...
	 * @mbg.generated  Tue Jun 06 22:11:58 CST 2017
	 */
	@Select({ "select", "id, student_id, meter50_sprint_time, meter50_sprint_score, standing_jump_distance, ",
	...
	@ResultMap("com.wzsport.generator.mapper.SportScoreMapper.BaseResultMap")
	...
	@Update({ "update wzsport_sport_score", "set student_id = #{studentId,jdbcType=BIGINT},",
			"meter50_sprint_time = #{meter50SprintTime,jdbcType=DECIMAL},",
