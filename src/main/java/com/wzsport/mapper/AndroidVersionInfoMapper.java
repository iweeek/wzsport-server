...
public interface AndroidVersionInfoMapper {
	...
	@Insert({ "insert into wzsport_android_version_info (version_name, version_code, ", "change_log, is_forced, ",
			"apk_url, created_at, ", "updated_at, is_published)",
			"values (#{versionName,jdbcType=VARCHAR}, #{versionCode,jdbcType=INTEGER}, ",
			"#{changeLog,jdbcType=VARCHAR}, #{isForced,jdbcType=BIT}, ",
			"#{apkUrl,jdbcType=VARCHAR}, #{createdAt,jdbcType=TIMESTAMP}, ",
			"#{updatedAt,jdbcType=TIMESTAMP}, #{isPublished,jdbcType=TINYINT})" })
	 ...
	 * @mbg.generated  Sat Aug 12 12:20:07 CST 2017
	 */
	@Select({ "select", "id, version_name, version_code, change_log, is_forced, apk_url, created_at, ",
			"updated_at, is_published", "from wzsport_android_version_info", "where id = #{id,jdbcType=BIGINT}" })
	...
	@Update({ "update wzsport_android_version_info", "set version_name = #{versionName,jdbcType=VARCHAR},",
			...
			"is_published = #{isPublished,jdbcType=TINYINT}", "where id = #{id,jdbcType=BIGINT}" })
