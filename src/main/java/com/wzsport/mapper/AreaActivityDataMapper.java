...
public interface AreaActivityDataMapper {
     ...
     * This method corresponds to the database table wzsport_area_activity_data
     *
     ...
     */
    @Insert({
        "insert into wzsport_area_activity_data (activity_id, acquisition_time, ",
        "longitude, latitude, ",
        ...
        "#{locationType,jdbcType=TINYINT}, #{createdAt,jdbcType=TIMESTAMP}, ",
    ...
    @Select({
        "select",
        "id, activity_id, acquisition_time, longitude, latitude, location_type, created_at, ",
        "updated_at",
     ...
     * @mbg.generated Fri Jul 28 20:53:11 CST 2017
     */
    int updateByExampleSelective(@Param("record") AreaActivityData record, @Param("example") AreaActivityDataExample example);
