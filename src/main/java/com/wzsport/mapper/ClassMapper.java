...
public interface ClassMapper {
	 ...
	 * @mbg.generated  Mon Apr 16 11:29:36 CST 2018
	 */
	@Insert({ "insert into wzsport_class (major_id, university_id, ", "name, grade)",
			"values (#{majorId,jdbcType=BIGINT}, #{universityId,jdbcType=BIGINT}, ",
			"#{name,jdbcType=VARCHAR}, #{grade,jdbcType=SMALLINT})" })
	 ...
	 * @mbg.generated  Mon Apr 16 11:29:36 CST 2018
	 */
	@Select({ "select", "id, major_id, university_id, name, grade", "from wzsport_class",
	...
	@Update({ "update wzsport_class", "set major_id = #{majorId,jdbcType=BIGINT},",
			...
			"grade = #{grade,jdbcType=SMALLINT}", "where id = #{id,jdbcType=BIGINT}" })
