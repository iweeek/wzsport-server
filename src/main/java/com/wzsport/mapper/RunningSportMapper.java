...
public interface RunningSportMapper {
	 ...
	 * @mbg.generated  Thu Jul 27 14:56:18 CST 2017
	 */
	@Insert({ "insert into wzsport_running_sport (university_id, name, ", "type, enabled, sample_num, ",
			"qualified_distance, qualified_cost_time, ", "min_cost_time, hourly_kcal_consumption, ",
			"acquisition_interval, created_at, ", "updated_at)",
			"values (#{universityId,jdbcType=BIGINT}, #{name,jdbcType=VARCHAR}, ",
			"#{type,jdbcType=VARCHAR}, #{enabled,jdbcType=BIT}, #{sampleNum,jdbcType=TINYINT}, ",
			"#{qualifiedDistance,jdbcType=INTEGER}, #{qualifiedCostTime,jdbcType=INTEGER}, ",
			"#{minCostTime,jdbcType=INTEGER}, #{hourlyKcalConsumption,jdbcType=INTEGER}, ",
	 ...
	 * @mbg.generated  Thu Jul 27 14:56:18 CST 2017
	 */
	@Select({ "select", "id, university_id, name, type, enabled, sample_num, qualified_distance, qualified_cost_time, ",
	...
	@Update({ "update wzsport_running_sport", "set university_id = #{universityId,jdbcType=BIGINT},",
			...
			"enabled = #{enabled,jdbcType=BIT},", "sample_num = #{sampleNum,jdbcType=TINYINT},",
