...
public interface ClassMapper {
	 ...
	 * @mbg.generated  Tue Jun 06 22:11:58 CST 2017
	 */
	@Insert({ "insert into wzsport_class (major_id, university_id, ", "name, gradle, created_at, ", "updated_at)",
			"values (#{majorId,jdbcType=BIGINT}, #{universityId,jdbcType=BIGINT}, ",
			"#{name,jdbcType=VARCHAR}, #{gradle,jdbcType=SMALLINT}, #{createdAt,jdbcType=TIMESTAMP}, ",
	 ...
	 * @mbg.generated  Tue Jun 06 22:11:58 CST 2017
	 */
	@Select({ "select", "id, major_id, university_id, name, gradle, created_at, updated_at", "from wzsport_class",
			"where id = #{id,jdbcType=BIGINT}" })
	@ResultMap("com.wzsport.generator.mapper.ClassMapper.BaseResultMap")
	...
	@Update({ "update wzsport_class", "set major_id = #{majorId,jdbcType=BIGINT},",
			...
			"gradle = #{gradle,jdbcType=SMALLINT},", "created_at = #{createdAt,jdbcType=TIMESTAMP},",
