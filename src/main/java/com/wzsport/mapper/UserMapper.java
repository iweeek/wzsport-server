...
public interface UserMapper {
	...
	@Insert({ "insert into wzsport_user (username, password, ", "university_id, user_type, ",
			"latest_token, avatar_url, ", "open_id)",
			"values (#{username,jdbcType=VARCHAR}, #{password,jdbcType=VARCHAR}, ",
			"#{universityId,jdbcType=BIGINT}, #{userType,jdbcType=TINYINT}, ",
			"#{latestToken,jdbcType=VARCHAR}, #{avatarUrl,jdbcType=VARCHAR}, ", "#{openId,jdbcType=VARCHAR})" })
	 ...
	 * @mbg.generated  Mon Apr 16 11:29:36 CST 2018
	 */
	@Select({ "select", "id, username, password, university_id, user_type, latest_token, avatar_url, ", "open_id",
