...
public interface AreaSportMapper {
	...
	@Insert({ "insert into wzsport_area_sport (name, is_enabled, ", "is_man, qualified_cost_time, ",
			"sample_num, hourly_kcal_consumption, ", "acquisition_interval, university_id)",
			"values (#{name,jdbcType=VARCHAR}, #{isEnabled,jdbcType=BIT}, ",
			"#{isMan,jdbcType=TINYINT}, #{qualifiedCostTime,jdbcType=INTEGER}, ",
			"#{sampleNum,jdbcType=TINYINT}, #{hourlyKcalConsumption,jdbcType=INTEGER}, ",
	 ...
	 * @mbg.generated  Fri Sep 08 16:11:01 CST 2017
	 */
	@Select({ "select", "id, name, is_enabled, is_man, qualified_cost_time, sample_num, hourly_kcal_consumption, ",
