...
public interface FixLocationOutdoorSportPointMapper {
     ...
     * This method corresponds to the database table wzsport_fix_location_outdoor_sport_point
     *
     ...
     */
    @Delete({
        "delete from wzsport_fix_location_outdoor_sport_point",
     ...
     */
    @Insert({
        "insert into wzsport_fix_location_outdoor_sport_point (name, latitude, ",
        "longitude, radius, ",
        "university_id)",
    ...
    @Select({
        "select",
        "id, name, latitude, longitude, radius, university_id",
        "from wzsport_fix_location_outdoor_sport_point",
        "where id = #{id,jdbcType=BIGINT}"
    })
     ...
     * @mbg.generated Fri Jul 21 15:05:33 CST 2017
     */
    int updateByExampleSelective(@Param("record") FixLocationOutdoorSportPoint record, @Param("example") FixLocationOutdoorSportPointExample example);
     ...
     * @mbg.generated Fri Jul 21 15:05:33 CST 2017
     */
    int updateByExample(@Param("record") FixLocationOutdoorSportPoint record, @Param("example") FixLocationOutdoorSportPointExample example);
     ...
     */
    @Update({
        "update wzsport_fix_location_outdoor_sport_point",
        "set name = #{name,jdbcType=VARCHAR},",
          "latitude = #{latitude,jdbcType=DECIMAL},",
          "longitude = #{longitude,jdbcType=DECIMAL},",
          "radius = #{radius,jdbcType=TINYINT},",
