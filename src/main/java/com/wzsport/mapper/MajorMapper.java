...
public interface MajorMapper {
	 ...
	 * @mbg.generated  Mon Apr 16 11:29:36 CST 2018
	 */
	@Insert({ "insert into wzsport_major (college_id, university_id, ", "name)",
			"values (#{collegeId,jdbcType=BIGINT}, #{universityId,jdbcType=BIGINT}, ", "#{name,jdbcType=VARCHAR})" })
	 ...
	 * @mbg.generated  Mon Apr 16 11:29:36 CST 2018
	 */
	@Select({ "select", "id, college_id, university_id, name", "from wzsport_major",
