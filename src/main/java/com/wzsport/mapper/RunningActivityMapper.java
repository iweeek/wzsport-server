...
public interface RunningActivityMapper {
	...
	@Insert({ "insert into wzsport_running_activity (project_id, student_id, ", "distance, step_count, ",
			...
			"calories_consumed, qualified, ", "ended, qualified_distance, ", "qualified_cost_time, min_cost_time, ",
			"created_at, updated_at)", "values (#{projectId,jdbcType=BIGINT}, #{studentId,jdbcType=BIGINT}, ",
			...
			"#{ended,jdbcType=BIT}, #{qualifiedDistance,jdbcType=INTEGER}, ",
	...
	@Select({ "select", "id, project_id, student_id, distance, step_count, cost_time, speed, step_per_second, ",
			"distance_per_step, target_finished_time, start_time, calories_consumed, qualified, ",
			"ended, qualified_distance, qualified_cost_time, min_cost_time, created_at, updated_at",
	...
	@Update({ "update wzsport_running_activity", "set project_id = #{projectId,jdbcType=BIGINT},",
			...
			"ended = #{ended,jdbcType=BIT},", "qualified_distance = #{qualifiedDistance,jdbcType=INTEGER},",
