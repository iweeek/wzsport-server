...
public interface WechatUserMapper {
     ...
     * This method corresponds to the database table wzsport_wechat_user
     *
     ...
     */
    @Delete({
        "delete from wzsport_wechat_user",
     ...
     */
    @Insert({
        "insert into wzsport_wechat_user (user_id, open_id, ",
        ...
        "#{city,jdbcType=VARCHAR}, #{headimgurl,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, user_id, open_id, nickname, sex, province, city, headimgurl, unionid",
        "from wzsport_wechat_user",
        "where id = #{id,jdbcType=BIGINT}"
    })
