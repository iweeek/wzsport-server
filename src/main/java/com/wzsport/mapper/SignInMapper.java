...
public interface SignInMapper {
    ...
    HashSet<SignIn> getAllSignInDataList(@Param("start") Date start, @Param("end") Date end);
    
    
    @Select("select * from wzsport_sign_in where sign_in_time between date(#{start}) and date(#{end})")
    HashSet<SignIn> getAllDataList(@Param("start") Date start, @Param("end") Date end);
}