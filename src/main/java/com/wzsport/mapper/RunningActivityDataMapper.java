...
public interface RunningActivityDataMapper {
    ...
    @Insert({ "insert into wzsport_running_activity_data (activity_id, acquisition_time, ", "step_count, distance, ",
            "distance_per_step, step_per_second, ", "longitude, latitude, ", "location_type, is_normal, ",
            "created_at, updated_at, ", "step_count_cal)",
     ...
     * @mbg.generated  Sat Oct 07 21:58:36 CST 2017
     */
    @Select({ "select", "id, activity_id, acquisition_time, step_count, distance, distance_per_step, ",
            "step_per_second, longitude, latitude, location_type, is_normal, created_at, ",
            "updated_at, step_count_cal", "from wzsport_running_activity_data", "where id = #{id,jdbcType=BIGINT}" })
    ...
    @Update({ "update wzsport_running_activity_data", "set activity_id = #{activityId,jdbcType=BIGINT},",
            ...
            "distance = #{distance,jdbcType=SMALLINT},", "distance_per_step = #{distancePerStep,jdbcType=DECIMAL},",
            ...
            "updated_at = #{updatedAt,jdbcType=TIMESTAMP},", "step_count_cal = #{stepCountCal,jdbcType=SMALLINT}",
