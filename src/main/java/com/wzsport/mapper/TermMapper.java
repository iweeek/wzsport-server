...
public interface TermMapper {
	 ...
	 * @mbg.generated  Mon Apr 16 11:29:36 CST 2018
	 */
	@Insert({ "insert into wzsport_term (university_id, name, ", "start_date, end_date)",
	 ...
	 * @mbg.generated  Mon Apr 16 11:29:36 CST 2018
	 */
	@Select({ "select", "id, university_id, name, start_date, end_date", "from wzsport_term",
	...
	@Update({ "update wzsport_term", "set university_id = #{universityId,jdbcType=BIGINT},",
			...
			"end_date = #{endDate,jdbcType=DATE}", "where id = #{id,jdbcType=BIGINT}" })
