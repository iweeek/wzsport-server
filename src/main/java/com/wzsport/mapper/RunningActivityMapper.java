...
=======
    ...
    @Insert({ "insert into wzsport_running_activity (running_sport_id, student_id, ", "distance, step_count, ",
            ...
            "kcal_consumed, qualified, ", "is_valid, qualified_distance, ", "qualified_cost_time, min_cost_time, ",
            ...
            "#{isValid,jdbcType=TINYINT}, #{qualifiedDistance,jdbcType=INTEGER}, ",
...
=======
    ...
    @Select({ "select", "id, running_sport_id, student_id, distance, step_count, cost_time, speed, step_per_second, ",
            ...
            "is_valid, qualified_distance, qualified_cost_time, min_cost_time, created_at, ",
            "updated_at, ended_at, ended_by", "from wzsport_running_activity", "where id = #{id,jdbcType=BIGINT}" })
>>>>>>> f_1035
