...
public interface StudentCoursePhysicalTestMapper {
     ...
     * This method corresponds to the database table wzsport_student_sports_course_physical_test_view
     *
     ...
     */
    @Insert({
        "insert into wzsport_student_sports_course_physical_test_view (university_id, college_name, ",
        "grade_no, class_no, ",
        "class_name, student_no, ",
        "nationality_no, nationality_name, ",
        "student_name, is_man, ",
        "birthday, home_address, ",
        "height, weight, ",
        "vital_capacity, fifty_run_time, ",
        "standing_long_jump, sit_and_reach, ",
        "eight_hundred_run_time, one_thousand_run_time, ",
        "one_minute_sit_up, pull_up, ",
        "is_tested, is_free_test, total_score, ",
        "school_year, term, course_name, ",
        "teacher_name, course_time, ",
        "major_name, is_pass)",
     ...
     * @mbg.generated Fri Mar 16 17:44:40 CST 2018
     */
    int updateByExampleSelective(@Param("record") StudentCoursePhysicalTest record, @Param("example") StudentCoursePhysicalTestExample example);
     ...
     * @mbg.generated Fri Mar 16 17:44:40 CST 2018
     */
    int updateByExample(@Param("record") StudentCoursePhysicalTest record, @Param("example") StudentCoursePhysicalTestExample example);
}