...
public interface AreaSportMapper {
	 ...
	 * @mbg.generated  Thu Aug 17 08:42:45 CST 2017
	 */
	@Insert({ "insert into wzsport_area_sport (name, is_enabled, ", "qualified_cost_time, sample_num, ",
	 ...
	 * @mbg.generated  Thu Aug 17 08:42:45 CST 2017
	 */
	@Select({ "select", "id, name, is_enabled, qualified_cost_time, sample_num, hourly_kcal_consumption, ",
	...
	@Update({ "update wzsport_area_sport", "set name = #{name,jdbcType=VARCHAR},",
			"is_enabled = #{isEnabled,jdbcType=BIT},", "qualified_cost_time = #{qualifiedCostTime,jdbcType=INTEGER},",
