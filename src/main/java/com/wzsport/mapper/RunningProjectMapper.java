...
public interface RunningProjectMapper {
	...
	@Insert({ "insert into wzsport_running_project (university_id, name, ", "type, enabled, qualified_distance, ",
			"qualified_cost_time, min_cost_time, ", "hourly_calorie_consumption, acquisition_interval, ",
			...
			"#{hourlyCalorieConsumption,jdbcType=INTEGER}, #{acquisitionInterval,jdbcType=TINYINT}, ",
	...
	@Select({ "select", "id, university_id, name, type, enabled, qualified_distance, qualified_cost_time, ",
			"min_cost_time, hourly_calorie_consumption, acquisition_interval, created_at, ", "updated_at",
