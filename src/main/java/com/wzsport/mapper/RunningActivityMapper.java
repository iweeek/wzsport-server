...
public interface RunningActivityMapper {
	...
	@Insert({ "insert into wzsport_running_activity (project_id, student_id, ", "distance, step_count, ",
			"cost_time, target_time, ", "start_time, calories_consumed, ", "qualified, created_at, ", "updated_at)",
			"values (#{projectId,jdbcType=BIGINT}, #{studentId,jdbcType=BIGINT}, ",
			"#{distance,jdbcType=INTEGER}, #{stepCount,jdbcType=SMALLINT}, ",
			"#{costTime,jdbcType=INTEGER}, #{targetTime,jdbcType=INTEGER}, ",
			"#{startTime,jdbcType=TIMESTAMP}, #{caloriesConsumed,jdbcType=INTEGER}, ",
			"#{qualified,jdbcType=BIT}, #{createdAt,jdbcType=TIMESTAMP}, ", "#{updatedAt,jdbcType=TIMESTAMP})" })
	 ...
	 * @mbg.generated  Tue Jun 20 15:40:44 CST 2017
	 */
	@Select({ "select", "id, project_id, student_id, distance, step_count, cost_time, target_time, start_time, ",
			"calories_consumed, qualified, created_at, updated_at", "from wzsport_running_activity",
	...
	@Update({ "update wzsport_running_activity", "set project_id = #{projectId,jdbcType=BIGINT},",
			...
			"target_time = #{targetTime,jdbcType=INTEGER},", "start_time = #{startTime,jdbcType=TIMESTAMP},",
