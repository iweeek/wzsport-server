...
public interface RunningSportMapper {
    ...
    @Insert({ "insert into wzsport_running_sport (university_id, name, ", "is_enabled, is_man, img_url, ",
            "qualified_distance, qualified_cost_time, ", "hourly_kcal_consumption, sample_num, ",
            "acquisition_interval)", "values (#{universityId,jdbcType=BIGINT}, #{name,jdbcType=VARCHAR}, ",
            ...
            "#{hourlyKcalConsumption,jdbcType=INTEGER}, #{sampleNum,jdbcType=INTEGER}, ",
