...
public interface FixLocationOutdoorSportPointMapper {
	...
	@Insert({ "insert into wzsport_fix_location_outdoor_sport_point (name, latitude, ", "longitude, radius, ",
			"qualified_cost_time, addr, ", "is_enable, description, ", "university_id)",
			...
			"#{isEnable,jdbcType=TINYINT}, #{description,jdbcType=VARCHAR}, ", "#{universityId,jdbcType=BIGINT})" })
	 ...
	 * @mbg.generated  Thu Aug 03 17:43:04 CST 2017
	 */
	@Select({ "select", "id, name, latitude, longitude, radius, qualified_cost_time, addr, is_enable, ",
	...
	@Update({ "update wzsport_fix_location_outdoor_sport_point", "set name = #{name,jdbcType=VARCHAR},",
			...
			"addr = #{addr,jdbcType=VARCHAR},", "is_enable = #{isEnable,jdbcType=TINYINT},",
