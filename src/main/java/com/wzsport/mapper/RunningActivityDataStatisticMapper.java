...
public interface RunningActivityDataStatisticMapper {
     ...
     * This method corresponds to the database table wzsport_running_activity_data_statistic
     *
     ...
     */
    @Delete({
        "delete from wzsport_running_activity_data_statistic",
     ...
     */
    @Insert({
        "insert into wzsport_running_activity_data_statistic (student_id, activity_id, ",
        "data_count, speed_against, ",
        "distance_per_step_against)",
        "values (#{studentId,jdbcType=BIGINT}, #{activityId,jdbcType=BIGINT}, ",
        "#{dataCount,jdbcType=INTEGER}, #{speedAgainst,jdbcType=INTEGER}, ",
    ...
    @Select({
        "select",
        "id, student_id, activity_id, data_count, speed_against, distance_per_step_against",
        "from wzsport_running_activity_data_statistic",
        "where id = #{id,jdbcType=BIGINT}"
    })
     ...
     * @mbg.generated Thu Nov 16 22:47:22 CST 2017
     */
    int updateByExampleSelective(@Param("record") RunningActivityDataStatistic record, @Param("example") RunningActivityDataStatisticExample example);
     ...
     * @mbg.generated Thu Nov 16 22:47:22 CST 2017
     */
    int updateByExample(@Param("record") RunningActivityDataStatistic record, @Param("example") RunningActivityDataStatisticExample example);
     ...
     */
    @Update({
        "update wzsport_running_activity_data_statistic",
