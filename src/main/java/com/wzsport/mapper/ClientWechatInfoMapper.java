...
public interface ClientWechatInfoMapper {
     ...
     * This method corresponds to the database table wzsport_client_wechat_info
     *
     ...
     */
    @Delete({
        "delete from wzsport_client_wechat_info",
     ...
     */
    @Insert({
        "insert into wzsport_client_wechat_info (open_id, user_id)",
    ...
    @Select({
        "select",
        "id, open_id, user_id",
        "from wzsport_client_wechat_info",
        "where id = #{id,jdbcType=BIGINT}"
    })
     ...
     * @mbg.generated Fri Aug 18 17:56:06 CST 2017
     */
    int updateByExampleSelective(@Param("record") ClientWechatInfo record, @Param("example") ClientWechatInfoExample example);
     ...
     */
    @Update({
        "update wzsport_client_wechat_info",
