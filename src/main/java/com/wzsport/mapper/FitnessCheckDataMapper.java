...
public interface FitnessCheckDataMapper {
	 ...
	 * @mbg.generated  Tue Jun 06 22:11:58 CST 2017
	 */
	@Insert({ "insert into wzsport_fitness_check_data (student_id, height, ", "weight, lung_capacity, ",
			"BMI, created_at, ", "updated_at)", "values (#{studentId,jdbcType=BIGINT}, #{height,jdbcType=INTEGER}, ",
			"#{weight,jdbcType=INTEGER}, #{lungCapacity,jdbcType=INTEGER}, ",
			"#{bmi,jdbcType=DECIMAL}, #{createdAt,jdbcType=TIMESTAMP}, ", "#{updatedAt,jdbcType=TIMESTAMP})" })
	 ...
	 * @mbg.generated  Tue Jun 06 22:11:58 CST 2017
	 */
	@Select({ "select", "id, student_id, height, weight, lung_capacity, BMI, created_at, updated_at",
			"from wzsport_fitness_check_data", "where id = #{id,jdbcType=BIGINT}" })
	@ResultMap("com.wzsport.generator.mapper.FitnessCheckDataMapper.BaseResultMap")
	...
	@Update({ "update wzsport_fitness_check_data", "set student_id = #{studentId,jdbcType=BIGINT},",
			"height = #{height,jdbcType=INTEGER},", "weight = #{weight,jdbcType=INTEGER},",
			"lung_capacity = #{lungCapacity,jdbcType=INTEGER},", "BMI = #{bmi,jdbcType=DECIMAL},",
