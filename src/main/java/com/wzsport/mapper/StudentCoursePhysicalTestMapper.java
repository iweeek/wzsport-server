...
public interface StudentCoursePhysicalTestMapper {
	...
	@Insert({ "insert into wzsport_student_sports_course_physical_test_view (university_id, college_name, ",
			...
			"is_tested, is_free_test, total_score, ", "school_year, year, ", "term, course_name, teacher_name, ",
			"course_time, major_name, ", "is_pass)",
			...
			"#{schoolYear,jdbcType=VARCHAR}, #{year,jdbcType=VARCHAR}, ",
			"#{term,jdbcType=BIT}, #{courseName,jdbcType=VARCHAR}, #{teacherName,jdbcType=VARCHAR}, ",
			"#{courseTime,jdbcType=VARCHAR}, #{majorName,jdbcType=VARCHAR}, ", "#{isPass,jdbcType=BIT})" })
