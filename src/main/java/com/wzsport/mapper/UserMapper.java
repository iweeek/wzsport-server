...
public interface UserMapper {
	...
	*/
     ...
     * This method corresponds to the database table wzsport_user
     *
     ...
     */
    @Insert({
        "insert into wzsport_user (username, password, ",
        "latest_token, created_at, ",
        "updated_at)",
        "values (#{username,jdbcType=VARCHAR}, #{password,jdbcType=VARCHAR}, ",
        "#{latestToken,jdbcType=VARCHAR}, #{createdAt,jdbcType=TIMESTAMP}, ",
    ...
    @Select({
        "select",
        "id, username, password, latest_token, created_at, updated_at",
        "from wzsport_user",
        "where id = #{id,jdbcType=BIGINT}"
    })
    @ResultMap("com.wzsport.generator.mapper.UserMapper.BaseResultMap")
