...
public interface UserMapper {
	...
	@Insert({ "insert into wzsport_user (username, password, ", "university_id, latest_token, ",
			...
			"#{avatarUrl,jdbcType=VARCHAR}, #{createdAt,jdbcType=TIMESTAMP}, ", "#{updatedAt,jdbcType=TIMESTAMP})" })
	 ...
	 * @mbg.generated  Fri Aug 18 10:38:11 CST 2017
	 */
	@Select({ "select", "id, username, password, university_id, latest_token, avatar_url, created_at, ", "updated_at",
