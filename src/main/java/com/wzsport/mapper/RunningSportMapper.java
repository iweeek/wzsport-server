...
public interface RunningSportMapper {
	 ...
	 * @mbg.generated  Sun Sep 03 10:28:31 CST 2017
	 */
	@Insert({ "insert into wzsport_running_sport (university_id, name, ", "is_enabled, is_man, qualified_distance, ",
			...
			"#{isEnabled,jdbcType=BIT}, #{isMan,jdbcType=TINYINT}, #{qualifiedDistance,jdbcType=INTEGER}, ",
	 ...
	 * @mbg.generated  Sun Sep 03 10:28:31 CST 2017
	 */
	@Select({ "select", "id, university_id, name, is_enabled, is_man, qualified_distance, qualified_cost_time, ",
	...
	@Update({ "update wzsport_running_sport", "set university_id = #{universityId,jdbcType=BIGINT},",
			...
			"is_man = #{isMan,jdbcType=TINYINT},", "qualified_distance = #{qualifiedDistance,jdbcType=INTEGER},",
