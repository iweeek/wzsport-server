...
public interface UniversityMapper {
	 ...
	 * @mbg.generated  Mon May 28 16:50:53 CST 2018
	 */
	@Insert({ "insert into wzsport_university (name)", "values (#{name,jdbcType=VARCHAR})" })
	 ...
	 * @mbg.generated  Mon May 28 16:50:53 CST 2018
	 */
	@Select({ "select", "id, name", "from wzsport_university", "where id = #{id,jdbcType=BIGINT}" })
	 ...
	 * @mbg.generated  Mon May 28 16:50:53 CST 2018
	 */
	@Update({ "update wzsport_university", "set name = #{name,jdbcType=VARCHAR}", "where id = #{id,jdbcType=BIGINT}" })
...
//			+"ORDER BY SUM(kcal_consumed) desc")
    ...
    @Select("SELECT student_id,name as student_name,avatar_url,SUM(kcal_consumed) AS kcal_consumption, university_id\n" +
...
//			+ "ORDER BY SUM(time_costed) desc ")
	@Select("SELECT student_id,name as student_name,avatar_url, SUM(cost_time) AS time_costed, university_id\n" +
			"FROM wzsport_student_sport_consume_statistic\n" +
			"WHERE university_id = #{universityId}\n" +
			"GROUP BY student_id\n" +
