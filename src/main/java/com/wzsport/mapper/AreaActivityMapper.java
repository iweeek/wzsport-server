...
public interface AreaActivityMapper {
    ...
    @Insert({ "insert into wzsport_area_activity (area_sport_id, location_id, ", "student_id, cost_time, ",
            "start_time, kcal_consumed, ", "qualified, qualified_cost_time, ", "is_valid, created_at, ",
            ...
            "#{isValid,jdbcType=TINYINT}, #{createdAt,jdbcType=TIMESTAMP}, ",
    ...
    @Select({ "select", "id, area_sport_id, location_id, student_id, cost_time, start_time, kcal_consumed, ",
            "qualified, qualified_cost_time, is_valid, created_at, updated_at, ended_at, ", "ended_by",
    ...
    @Update({ "update wzsport_area_activity", "set area_sport_id = #{areaSportId,jdbcType=BIGINT},",
            ...
            "qualified_cost_time = #{qualifiedCostTime,jdbcType=INTEGER},", "is_valid = #{isValid,jdbcType=TINYINT},",
